...
-- Q6. How many unique category we have?
SELECT DISTINCT category FROM retail_sales;

-- Q7. Write a SQL query to retrieve all column  for sale made on '2022-11-05' 
SELECT * FROM retail_sales
WHERE sale_date = '2022-11-05';

-- Q8. Write a SQL query to retrieve all the transactions where the category is 'Clothing'
...
-- Q9. Write a SQL query to calculate the total sales(total_sale) for each category
-- and count the total orders.
SELECT category, sum(total_sale), COUNT(*) AS total_orders
FROM retail_sales
GROUP BY category;

-- Q10. Write a SQL query to find the average age of customer 
...
-- Q12. Write a SQL query to find the total number of transactions(transactions_id) 
...
-- Q13. Write a SQL query to calculate the average sale for each month.
...
-- Q14. Write a SQL query to find the top 5 customers based on the highest total sale.
...
-- Q15. Write SQL query to find the number of unique customers
-- who purchased items from each category.
SELECT category, COUNT(DISTINCT customer_id) AS unique_customers 
FROM retail_sales
GROUP BY 1;

-- Q16. Write a SQL query to create each shift and number of orders (Example Morning <12,
